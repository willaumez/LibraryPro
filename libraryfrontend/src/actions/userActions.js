...
export const signup = (name, email, password) => async (dispatch) => {
        try {
                ...
                const {data} = await axios.post('/api/users/signup/', {'name':name, 'email':email, 'password':password}, config)
                dispatch({
...
export const createUser = (nameCreate, emailCreate, password, isStaff) => async (dispatch, getState) => {
        try {
                ...
                const {data} = await axios.post('/api/users/create/', {'name':nameCreate,
                        'email':emailCreate, 'password':password, 'is_staff': isStaff}, config)
                dispatch({
