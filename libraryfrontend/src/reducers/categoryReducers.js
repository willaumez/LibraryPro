import { CATEGORY_LIST_REQUEST, CATEGORY_LIST_SUCCESS, CATEGORY_LIST_FAIL,
...
export const categoryCreateReducers = ( state = { },  action) => {
    switch (action.type) {
...
export const categoryUpdateReducers = ( state = { category: { } },  action) => {
    switch (action.type) {
