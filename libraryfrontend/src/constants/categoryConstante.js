...
export const CATEGORY_NAME_REQUEST = 'CATEGORY_NAME_REQUEST'
export const CATEGORY_NAME_SUCCESS = 'CATEGORY_NAME_SUCCESS'
export const CATEGORY_NAME_FAIL = 'CATEGORY_NAME_FAIL'
export const CATEGORY_NAME_RESET = 'CATEGORY_NAME_RESET'